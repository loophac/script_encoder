...
def logo():
     ...
     print ("     Rebuilt by S1lv3r(Loophac) for user interface and easily demployment of scripts/text files 2017")
     print ("     h for help\n")
     question = input("Which type of output file do you want?: ")
     if question == "h":
        print("txt,python,batch,or bash")
        return logo
